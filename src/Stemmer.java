...
import java.text.DateFormat;
	...
	public class Stemmer
	{
	    ...
	    // constructor
	    public Stemmer ( File fileToBeStemmed, Vector statFiles )
	    {
...
//	    				    String var_3 = tokens[2];
	    ...
	    public Stemmer() throws IOException,FileNotFoundException,UnsupportedEncodingException{
	    	this.statfiles();
	    }  
